...
public:
	...
	void PointerExpired(AbstractClass* instance, bool removed = true) override JMP_THIS(0x4D9960);
	...
	bool CanBeSold() const override JMP_THIS(0x4D9E70);
	...
	void Override_Mission(Mission mission, AbstractClass* target, AbstractClass* destination) override JMP_THIS(0x4D8F40);
	bool Mission_Revert() override JMP_THIS(0x4D8F80);
	int32_t Mission_Attack() override JMP_THIS(0x4D4DC0);
	int32_t Mission_Capture() override JMP_THIS(0x4D4B20);
	int32_t Mission_Eaten() override JMP_THIS(0x4D4CB0);
	int32_t Mission_Guard() override JMP_THIS(0x4D5070);
	int32_t Mission_AreaGuard() override JMP_THIS(0x4D6AA0);
	int32_t Mission_Hunt() override JMP_THIS(0x4D5350);
	int32_t Mission_Move() override JMP_THIS(0x4D4200);
	int32_t Mission_Retreat() override JMP_THIS(0x4DA2C0);
	int32_t Mission_Unload() override JMP_THIS(0x4DA2B0);
	int32_t Mission_Enter() override JMP_THIS(0x4D9290);
	int32_t Mission_Rescue() override JMP_THIS(0x4DDF90);
	int32_t Mission_Patrol() override JMP_THIS(0x4D4280);
	...
	void AddPassenger(FootClass* cargo) override JMP_THIS(0x4DE630);
	...
	Mission RespondMegaEventMission(EventClass* pRespondTo) override JMP_THIS(0x4DF0E0);
