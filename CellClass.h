...
public:
	...
	RTTIType WhatAmI() const override JMP_THIS(0x487E60);
	int Size() const override JMP_THIS(0x487E70);

	Coordinate* __GetCoords(Coordinate& retstr) const override JMP_THIS(0x486840);
	bool IsOnFloor() const override JMP_THIS(0x4867E0);
	Coordinate* __GetCenterCoords(Coordinate& retstr) const override JMP_THIS(0x486890);
public:
	...
	Coordinate* __GetCellCoords(Coordinate& retstr) const JMP_THIS(0x480A30);
	Coordinate GetCellCoords() const
	{
		Coordinate ret;
		__GetCellCoords(ret);
		return ret;
...
#define ISTILE(tileset, addr) \
	...
	Coordinate GetCoordsWithBridge() const { return FixHeight(this->GetCenterCoords()); }
