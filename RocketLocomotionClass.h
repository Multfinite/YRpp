...
public:
    ...
    Coordinate __stdcall Destination() override JMP_STD(0x661FB0);
    //Coordinate __stdcall Head_To_Coord() override;
    ...
    void __stdcall Move_To(Coordinate to) override JMP_STD(0x6632E0);
