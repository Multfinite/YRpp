...
public:
	...
	void PointerExpired(AbstractClass* instance, bool removed) override JMP_THIS(0x41B660);
	RTTIType WhatAmI() const override JMP_THIS(0x41C180);
	int Size() const override JMP_THIS(0x41C170);
	void ComputeCRC(CRCEngine& crc) const override JMP_THIS(0x41B610);
	bool IsOnFloor() const override JMP_THIS(0x41B980);
	...
	ObjectTypeClass* GetType() const override JMP_THIS(0x41C200);
	const wchar_t* GetUIName() const override JMP_THIS(0x41C1D0);
	...
	Move IsCellOccupied(CellClass* pDestCell, FacingType facing, int level, CellClass* pSourceCell, bool alt) const override JMP_THIS(0x4196B0);
	
	void QueueMission(Mission mission, bool commence) override JMP_THIS(0x41BA90);
	bool NextMission() override JMP_THIS(0x41B870);
	void ForceMission(Mission mission) override JMP_THIS(0x41B9F0);
	void Override_Mission(Mission mission, AbstractClass* target, AbstractClass* destination) override JMP_THIS(0x41BB30);
	bool ReadyToNextMission() override JMP_THIS(0x41B5E0);
	int Mission_Attack() override JMP_THIS(0x417FE0);
	int Mission_Guard() override JMP_THIS(0x41A5C0);
	int Mission_AreaGuard() override JMP_THIS(0x41A940);
	int Mission_Hunt() override JMP_THIS(0x414A80);
	int Mission_Move() override JMP_THIS(0x4166C0);
	int Mission_Retreat() override JMP_THIS(0x415A50);
	int Mission_Unload() override JMP_THIS(0x4151E0);
	int Mission_Enter() override JMP_THIS(0x419C80);
	int Mission_Patrol() override JMP_THIS(0x417300);
	int Mission_ParaDropApproach() override JMP_THIS(0x4158E0);
	int Mission_ParaDropOverfly() override JMP_THIS(0x415960);
	int Mission_SpyPlaneApproach() override JMP_THIS(0x4155F0);
	int Mission_SpyPlaneOverfly() override JMP_THIS(0x4157C0);
