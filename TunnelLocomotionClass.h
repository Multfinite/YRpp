...
public:
	...
	CoordStruct __stdcall Destination() override JMP_STD(0x728A90);
	...
	void __stdcall Move_To(CoordStruct to) override JMP_STD(0x728AF0);
	...
	int SizeOf() const override JMP_THIS(0x72A200);
