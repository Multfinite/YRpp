...
public:
	...
	*/
	...
	/* Play a sound at a certain Position.
		n = Index of VocClass in Array to be played
	*/
	static void __fastcall PlayAt(int n, const Coordinate& coords, AudioController* pCtrl = nullptr)
		JMP_STD(0x7509E0);

	// calls the one above ^ - probably sanity checks and whatnot
	static void __fastcall PlayIndexAtPos(int n, const Coordinate& coords, int a3 = 0)
		JMP_STD(0x750E20);
