...
public:
	...
	void PointerExpired(AbstractClass* instance, bool removed) override JMP_THIS(0x5F5230);
	void ComputeCRC(CRCEngine& crc) const override JMP_THIS(0x5F6250);
	bool IsDead() const override JMP_THIS(0x5F6690);
	Coordinate* __GetCoords(Coordinate& retstr) const override JMP_THIS(0x5F65A0);
	bool IsOnFloor() const override JMP_THIS(0x5F6B60);
	...
	*/
	virtual TechnoTypeClass* GetTechnoType() const JMP_THIS(0x5F6BC0);
	...
	*/
	virtual ObjectTypeClass* GetType() const JMP_THIS(0x4E0130);
	...
	*/
	virtual DWORD GetTypeOwners() const JMP_THIS(0x5F42A0);
	...
	*/
	virtual const wchar_t* GetUIName() const JMP_THIS(0x4263C0);
	...
	*/
	virtual bool CanBeRepaired() const JMP_THIS(0x5F42B0);
	...
	*/
	virtual bool CanBeSold() const JMP_THIS(0x5F42C0);
	...
	*/
	virtual Coordinate* __GetTargetCoords(Coordinate& retstr) const JMP_THIS(0x41BDD0);
	__forceinline Coordinate GetTargetCoords() const
	{
		Coordinate ret;
		__GetTargetCoords(ret);
		return ret;
	}
	...
	*/
	virtual Coordinate* __GetDockCoords(Coordinate& retstr, TechnoClass* docker) const JMP_THIS(0x5F6C80);
	__forceinline Coordinate GetDockCoords(TechnoClass* docker) const
	{
		Coordinate ret;
		__GetDockCoords(ret, docker);
		return ret;
	}
	...
	*/
	virtual Coordinate* __GetRenderCoords(Coordinate& retstr) const JMP_THIS(0x41BE00);
	__forceinline Coordinate GetRenderCoords() const
	{
		Coordinate ret;
		__GetRenderCoords(ret);
		return ret;
	}
	...
	*/
	virtual Coordinate* __GetFLH(Coordinate& retstr, int idxWeapon, Coordinate baseCoords) const JMP_THIS(0x4263D0);
	__forceinline Coordinate GetFLH(int idxWeapon, Coordinate baseCoords) const
	{
		Coordinate ret;
		__GetFLH(ret, idxWeapon, baseCoords);
		return ret;
	}
	...
	*/
	virtual Coordinate* __GetExitCoords(Coordinate& retstr, DWORD dwUnk = 0) const JMP_THIS(0x41BE30);
	__forceinline Coordinate GetExitCoords(DWORD dwUnk = 0) const
	{
		Coordinate ret;
		__GetExitCoords(ret, dwUnk);
		return ret;
	}
	...
	*/
	virtual ObjectTypeClass* GetDisguise(bool disguisedAgainstAllies) const JMP_THIS(0x41BE60);

	/*!
	* @note vtable_index 52:0xD0
	* @note address 0x41BE70
	*/
	virtual HouseClass* GetDisguiseHouse(bool disguisedAgainstAllies) const JMP_THIS(0x41BE70);
	...
	*/
	virtual void RegisterDestruction(ObjectClass const* destroyedBy) JMP_THIS(0x5F42F0);
	...
	*/
	virtual void RegisterKill(HouseClass const* destroyedBy) JMP_THIS(0x5F4300);
	...
	*/
	virtual void Shimmer() JMP_THIS(0x5F4310);
	...
	*/
	virtual ::Cell const* GetFoundationData(bool includeBib = false) const JMP_THIS(0x5F5B90);
	...
	*/
	virtual RectangleStruct* __GetDimensions(RectangleStruct& retstr) const JMP_THIS(0x5F4730);
	__forceinline RectangleStruct GetDimensions() const
	{
		RectangleStruct ret;
		__GetDimensions(ret);
		return ret;
	...
	*/
	virtual RectangleStruct* __GetRenderDimensions(RectangleStruct& retstr) const JMP_THIS(0x5F4870);
	__forceinline RectangleStruct GetRenderDimensions() const
	{
		RectangleStruct ret;
		__GetRenderDimensions(ret);
		return ret;
	}
	...
	*/
	virtual bool IsCloseEnough3D(Coordinate coord, int idxWeapon) const JMP_THIS(0x5F4380);
	...
	*/
	virtual int GetWeaponRange(int idxWeapon) const JMP_THIS(0x5F4390);
	...
	*/
	virtual DWORD GetPointsValue() const JMP_THIS(0x5F43D0);
	...
	*/
	virtual ::Cell* GetMapCoords(::Cell& retstr) const JMP_THIS(0x41BEA0);
	::Cell GetMapCoords() const
	{
		::Cell ret;
		GetMapCoords(ret);
		return ret;
	...
	*/
	virtual ::Cell* GetMapCoordsAgain(::Cell& retstr) const JMP_THIS(0x5F69C0);
	::Cell GetMapCoordsAgain() const
	{
		::Cell ret;
		GetMapCoordsAgain(ret);
		return ret;
	}
	...
	*/
	virtual int GetZ() const JMP_THIS(0x5F5F30);
	...
	*/
	virtual LightConvertClass* GetRemapColour() const JMP_THIS(0x426520);
	...
	*/
	DirStruct* __GetTargetDirection(DirStruct& retstr, AbstractClass* pTarget) const JMP_THIS(0x5F3DB0);
	__forceinline DirStruct GetTargetDirection(AbstractClass* pTarget) const
	{
		DirStruct ret;
		__GetTargetDirection(ret, pTarget);
		return ret;
	}
	/*!
	* @note in EXE this is method of ObjectClass, but it can be used with any Abstract.
	...
	*/
	...
	double GetHealthPercentage() const { return static_cast<double>(this->Health) / this->GetType()->Strength; }
