...
{
public:
	DEFINE_POINTER(DynamicVectorClass<PlanningNodeClass*>, Unknown1, 0xAC4B30u)
	DEFINE_POINTER(DynamicVectorClass<PlanningNodeClass*>, Unknown2, 0xAC4C18u)
	DEFINE_POINTER(DynamicVectorClass<PlanningNodeClass*>, Unknown3, 0xAC4C98u)
