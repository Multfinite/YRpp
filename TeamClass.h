...
public:
	...
	void PointerExpired(AbstractClass* instance, bool removed = true) override JMP_THIS(0x6EAE60);
	RTTIType WhatAmI() const override JMP_THIS(0x6F0440);
	int Size() const override JMP_THIS(0x6F0430);
