...
public:
    ...
    void PointerExpired(AbstractClass* instance, bool removed = true) override JMP_THIS(0x726690);
    RTTIType WhatAmI() const override JMP_THIS(0x726940);
    int Size() const override JMP_THIS(0x726930);
