...
public:
	...
	// Units that are considered to have fulfilled their purpose and useless. Harvesters that cannot do anything without player input are considered this. AI will sell these units on Service Depots.
	bool             IsUseless;
...
public:
	...
	void PointerExpired(AbstractClass* instance, bool removed) override JMP_THIS(0x7077C0);
	...
	void AnimPointerExpired(AnimClass* anim) override JMP_THIS(0x710410);
	...
	TechnoTypeClass* GetTechnoType() const override JMP_THIS(0x6F3270);
	DWORD GetTypeOwners() const override JMP_THIS(0x708B30);
	bool CanBeRepaired() const override JMP_THIS(0x701140);
	bool CanPlayerFire() const override JMP_THIS(0x7010D0);
	bool IsControllable() const override JMP_THIS(0x700C40);
	Coordinate* __GetFLH(Coordinate& retstr, int idxWeapon, Coordinate BaseCoords) const override JMP_THIS(0x6F3AD0);
	...
	void RegisterDestruction(ObjectClass const* destroyedBy) override JMP_THIS(0x702D40);
	void RegisterKill(HouseClass const* destroyedBy) override JMP_THIS(0x703230);
	void Shimmer() override JMP_THIS(0x703850);
	...
	bool IsCloseEnough3D(Coordinate coord, int idxWeapon) const override JMP_THIS(0x6F7970);
	int GetWeaponRange(int idxWeapon) const override JMP_THIS(0x7012C0);
	...
	DWORD GetPointsValue() const override JMP_THIS(0x707DD0);
	...
	LightConvertClass* GetRemapColour() const override JMP_THIS(0x705D70);
	void Override_Mission(Mission mission, AbstractClass* target, AbstractClass* destination) override JMP_THIS(0x7013A0);
	bool Mission_Revert() override JMP_THIS(0x7013E0);
	...
	*/
	...
	__forceinline DirStruct TurretFacing() const
	{
		DirStruct ret;
		__TurretFacing(ret);
		return ret;
	...
	*/
	...
	__forceinline DirStruct UnknownFireangle(TechnoClass* techno)
	{
		DirStruct ret;
	...
	*/
	...
	__forceinline ::Cell GetLastFlightMapCoords() const
	{
		::Cell ret;
	...
	*/
	virtual ::Cell* __FindExitCell(::Cell& retstr, DWORD dwUnk2, DWORD dwUnk3) const JMP_THIS(0x70AD50);
	__forceinline ::Cell FindExitCell(DWORD dwUnk2, DWORD dwUnk3) const
	{
		::Cell ret;
		__FindExitCell(ret, dwUnk2, dwUnk3);
		return ret;
	}
	...
	*/
	virtual Coordinate* __FiringOffset(Coordinate& retstr, DWORD dwUnk2) const JMP_THIS(0x6F3D60);
	__forceinline Coordinate FiringOffset(DWORD dwUnk2) const
	{
		Coordinate ret;
		__FiringOffset(ret, dwUnk2);
		return ret;
	}
	...
	*/
	...
	__forceinline DirStruct GetRealFacing() const
	{
		DirStruct ret;
		__GetRealFacing(ret);
		return ret;
	...
	*/
	...
	__forceinline Coordinate GetAttackCoordinates() const
	{
		Coordinate ret;
	...
	*/
	virtual void UpdateLastSight(bool incremental, int unused, bool toOtherHouse, HouseClass* otherHouse) JMP_THIS(0x70B1D0);
	...
	*/
	virtual Mission RespondMegaEventMission(EventClass* pRespondTo) JMP_THIS(0x70F000);
	...
	*/
	...
	__forceinline Coordinate GetAttackMoveCoords() const
	{
		Coordinate ret;
	...
	*/
	Coordinate* __CotCoord_70C690(Coordinate& retstr, Coordinate* a3, CellClass* a4, int32_t a5) JMP_THIS(0x70C690);
	__forceinline Coordinate CotCoord_70C690(Coordinate* a3, CellClass* a4, int32_t a5)
	{
		Coordinate ret;
		__CotCoord_70C690(ret, a3, a4, a5);
		return ret;
	}
	...
	*/
	...
	__forceinline Coordinate GetCoord_70BCB0()
	{
		Coordinate ret;
	...
	*/
	...
	{
		// what TS does
		if (maxStrength > 0 && this->Health > maxStrength)
		{
