...
public:
	...
	Coordinate __stdcall Destination() override JMP_STD(0x4CCAE0);
	...
	void __stdcall Move_To(Coordinate to) override JMP_STD(0x4CCC80);
	...
	int Size() const override JMP_THIS(0x4D0390);
