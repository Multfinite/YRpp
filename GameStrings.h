...
struct GameStrings
{
	...
	GAMEMD_STR(SYNCNAME_TXT, 0x838EB0);
	GAMEMD_STR(SYNCNAME2_TXT, 0x839194);
	...
	GAMEMD_STR(MISSIONMD_INI, 0x839724u);
	//..
	...
	GAMEMD_STR(GameMode, 0x83EFD0);
	GAMEMD_STR(Bases, 0x83D010);
	GAMEMD_STR(Credits, 0x824E38);
	GAMEMD_STR(Crates, 0x83CFF8);
	GAMEMD_STR(ShortGame, 0x83CFA8);
	GAMEMD_STR(SuperWeaponsAllowed, 0x83CF94);
	GAMEMD_STR(BuildOffAlly, 0x83CF84);
	GAMEMD_STR(GameSpeed, 0x8332E8);
	GAMEMD_STR(MultiEngineer, 0x83CFC8);
	GAMEMD_STR(UnitCount, 0x83D06C);
	GAMEMD_STR(MaxUnitCount, 0x83D05C);
	GAMEMD_STR(MinUnitCount, 0x83D078);
	GAMEMD_STR(AIPlayers, 0x83D040);
	GAMEMD_STR(AIDifficulty, 0x83D04C);
	GAMEMD_STR(AlliesAllowed, 0x8308AC);
	GAMEMD_STR(HarvesterTruce, 0x83CFD8);
	GAMEMD_STR(FogOfWar, 0x83CF78);
	...
	GAMEMD_STR(GasCloudSys, 0x83DA90);
	...
	GAMEMD_STR(TXT_COMPUTER, 0x824FC8);
	GAMEMD_STR(TXT_ERROR_LOADING_GAME, 0x829EA4);
	GAMEMD_STR(TXT_UNABLE_READ_SCENARIO, 0x831AF0);

	GAMEMD_STR(GUI_Debug, 0x827AF8);
	GAMEMD_STR(GUI_CursorCheat, 0x827AE8);

	GAMEMD_STR(GUI_AIHard, 0x831C4C);
	GAMEMD_STR(GUI_AINormal, 0x831C58);
	GAMEMD_STR(GUI_AIEasy, 0x831C68);
	GAMEMD_STR(GUI_DEBUG, 0x827AF8);
