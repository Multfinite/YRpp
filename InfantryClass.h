...
public:
	...
	void PointerExpired(AbstractClass* instance, bool remove) override JMP_THIS(0x51AA10);
	RTTIType WhatAmI() const override JMP_THIS(0x523340);
	int Size() const override JMP_THIS(0x5232F0);
	...
	ObjectTypeClass* GetType() const override JMP_THIS(0x51FAF0);
	const wchar_t* GetUIName() const override JMP_THIS(0x51F2C0);
	Coordinate* __GetFLH(Coordinate& retstr, int idxWeapon, Coordinate BaseCoords) const override JMP_THIS(0x523250);
	bool IsDisguisedAs(HouseClass* target) const override JMP_THIS(0x5227F0);
	ObjectTypeClass* GetDisguise(bool disguisedAgainstAllies) const override JMP_THIS(0x522640);
	HouseClass* GetDisguiseHouse(bool disguisedAgainstAllies) const override JMP_THIS(0x5226C0);
	...
	bool ReadyToNextMission() override JMP_THIS(0x521B60);
	...
	int Mission_Harvest() override JMP_THIS(0x522E70);
	int Mission_Hunt() override JMP_THIS(0x51F540);
	...
	Coordinate* __FiringOffset(Coordinate& retstr, DWORD unk) const override JMP_THIS(0x521D30);
	...
	void ClearDisguise() override JMP_THIS(0x522780);
	...
	*/
	virtual bool TryChangeState(InfantryState index, bool force = false, bool randomStartFrame = false) JMP_THIS(0x51D6F0);
